...
from pcaps.reader.single import FilterFn, PcapReader
...
class MultiPcapReader:
    ...
    def __init__(self) -> None:
        self._world_first_time: Optional[float] = None

    def reset(self) -> None:
        self._world_first_time = None

    @property
    def world_first_time(self) -> Optional[float]:
        return self._world_first_time

    def read(self, pcap_file_path: str, filter_fn: Optional[FilterFn] = None) -> PcapReader:
